...
int main() {
    ...
    //hárömszöggeci
    float triangle_Verticles[] = { -0.5f, -0.5f, 0,       1.0f,0.0f,0.0f,
                         -0.5f, 0.5f, 0,      0.0f,1.0f,0.0f,
                         0.5f, -0.5f, 0,      0.0f,0.0f,1.0f,
                         0.5f, 0.5f, 0,       0.5f,0.5f,1.0f,
                         -0.5f, 0.5f, 0,      0.0f,1.0f,0.0f,
                           0.5f, -0.5f, 0,     0.0f,0.0f,1.0f
    ...
    glGenBuffers(1, &vertex_buffer_object);
    {
        ...
        glBufferData(GL_ARRAY_BUFFER, sizeof(float) * 3 * 3 * 2 * 2, triangle_Verticles, GL_STATIC_DRAW);
